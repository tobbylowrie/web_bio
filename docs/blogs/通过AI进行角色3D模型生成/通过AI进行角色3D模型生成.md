...
![腾讯混元3D](/images/通过AI进行角色3D模型生成/image.png)

![alt text](/images/通过AI进行角色3D模型生成/image-1.png)

他首先免费使用，每天限制次数20次。并且是目前为止我所看到的能免费进行多参考图（多视角）进行3D模型生成的AI

### Tripo Studio

![alt text](/images/通过AI进行角色3D模型生成/image-2.png)
...
![alt text](/images/通过AI进行角色3D模型生成/image-3.png)
...
![alt text](/images/通过AI进行角色3D模型生成/image-4.png)

如果此时我们换一个视角进行观察，比如切换到侧视角，就会发现一个更严重的问题，模型完全被“压缩了”，如上图所示

![alt text](/images/通过AI进行角色3D模型生成/image-5.png)
...
![alt text](/images/通过AI进行角色3D模型生成/image-6.png)
...
![alt text](/images/通过AI进行角色3D模型生成/image-7.png)
